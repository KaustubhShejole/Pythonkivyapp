...
class FirstWindow(Screen):
    ...
    def shownow(self):
        ...
        player[0] = self.toss[r]
        player[1] = self.toss[1-r]
        return self.toss[r]
    def open_popup(self):
        pop = MyPopUp()
...
class tab2(GridLayout):
    ...
    def result(self):
        if self.b1.text.lower() == "x" and self.b2.text.lower() == "x" and self.b3.text.lower() == "x":
            self.all(True)
            self.ans = str(p[0])+' is the Winner'
            self.back()
            ...
            self.ans = str(p[0])+' is the Winner'
            self.back()
        elif self.b1.text.lower() == "0" and self.b2.text.lower() == "0" and self.b3.text.lower() == "0":
            self.all(True)
            self.ans = str(p[1])+' is the Winner'
            self.back()
